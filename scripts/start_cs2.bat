...
-cmdLine "-steam -insecure +sv_lan 1 -sw -w -console -w 640 -h 480 +mirv_script_load \"C:\Users\sus_things\Desktop\advancedfx-main\misc\mirv-script\dist\4-advanced-websockets\index.mjs\" +r_fullscreen 0"
